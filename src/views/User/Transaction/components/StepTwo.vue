...
// Helper function to format currency image path
const getCurrencyImagePath = (currencyCode) => {
  // Format the currency code to lowercase and return the image path
...
//   localForm.value.nickname = beneficiary.name;
...
const navigateToAddBeneficiary = () => {
  emit("nextStep"); // Redirect to the add beneficiary form, modify if different
};
